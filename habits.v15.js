...
// --- Heatmap helpers/state (must be defined before first render) ---
function rangeDates(rangeDays, offsetDays){
  // forward range: today+offset .. today+offset+rangeDays-1
  const base = new Date();
...
let analyticsView = localStorage.getItem("habitsAnalyticsView") || "week";
