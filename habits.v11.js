...
// analytics state (single source of truth)
var analyticsView = localStorage.getItem("habitsAnalyticsView") || "week";
var analyticsOffsetDays = parseInt(localStorage.getItem("habitsAnalyticsOffsetDays") || "0", 10);
var analyticsPaintMode = localStorage.getItem("habitsAnalyticsPaintMode") || "mark"; // mark | erase
